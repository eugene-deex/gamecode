...
DECLARE_DELEGATE_OneParam(FOnInterObjFound, FName);
...
public:
	...
	void Reload();
	FOnInterObjFound OnInterObjFound;
	...
	FORCEINLINE UCharacterInventoryComponent* GetInventoryComp() { return InventoryComp; }
	...
	bool PickupItem(UInventoryItem* ItemToPickup);
	bool PickupItem(UInventoryItem* ItemToPickup, uint32 Count);
	void UseInventory();
...
protected:
	...
	float LineOfSightDist = 500.f;

	// search for interactive object in front of the player
	void TraceOfSight();
