...
void ABasePlayerController::SetupInputComponent()
{
	...
	InputComponent->BindAction("EquipSideArm", IE_Pressed, this, &ABasePlayerController::EquipSideArm);
	...
	InputComponent->BindAction("EquipShotgunWeapon", IE_Pressed, this, &ABasePlayerController::EquipShotgunWeapon);
	InputComponent->BindAction("EquipPrimaryItem", IE_Pressed, this, &ABasePlayerController::EquipPrimaryItem); // grenade
	InputComponent->BindAction("Unequip", IE_Pressed, this, &ABasePlayerController::Unequip); // grenade
	
	InputComponent->BindAction("SwitchWeaponMode", IE_Pressed, this, &ABasePlayerController::SwitchWeaponMode);
}
...
void ABasePlayerController::CreateAndInitWidgets()
{
	...
	if (CharCached.IsValid() && IsValid(PlayerHUDWidget))
	{
		...
		if (IsValid(ReticleWidget))
		{
			...
			CharEquip->OnEquippedItemChangedEvent.AddUFunction(ReticleWidget, FName("OnEquippedItemChanged"));
		}
		...
		if (IsValid(AmmoWidget))
		{
			...
			CharEquip->OnGrenadesAmmoChangedEvent.AddUFunction(AmmoWidget, FName("UpdateGrenadesAmmoCounter"));
		}
...
void ABasePlayerController::EquipSideArm()
{
	if (CharCached.IsValid())
	{
		CharCached->EquipSideArm();
	}
}
...
void ABasePlayerController::EquipSecondaryWeapon()
{
	if (CharCached.IsValid())
	{
		CharCached->EquipSecondaryWeapon();
	}
}
...
void ABasePlayerController::EquipPrimaryItem()
{
	if (CharCached.IsValid())
	{
		CharCached->EquipPrimaryItem();
	}
}

void ABasePlayerController::EquipShotgunWeapon()
{
	if (CharCached.IsValid())
	{
		CharCached->EquipShotgunWeapon();
	}
}

void ABasePlayerController::Unequip()
{
	if (CharCached.IsValid())
	{
		CharCached->Unequip();
...
void ABasePlayerController::SwitchWeaponMode()
{
	if (CharCached.IsValid())
	{
		CharCached->SwitchWeaponMode();
	}
}
